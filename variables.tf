...
variable "alpha_project_id" {
  type        = string
  description = "ID of the alpha NSX Project, whose built-in default group (PROJECT-<id>-default) is used as the source for the prod01-9lqzy namespace's DROP rule."
}
